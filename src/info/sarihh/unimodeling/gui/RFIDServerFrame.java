...
import info.sarihh.unimodeling.utility.ClientHandler;
 ...
 */
public class RFIDServerFrame extends javax.swing.JInternalFrame {

    /**
     * Creates new form RFIDServerFrame
     */
    public RFIDServerFrame(UniModelingGUI uniModelingGUI) {
    ...
    private void initComponents() {
        ...
        portNumberTextField = new javax.swing.JFormattedTextField(new DefaultFormatter() {
        ...
        condensingStartsLabel = new javax.swing.JLabel();
        condensingStartsTextField = new javax.swing.JFormattedTextField(new DefaultFormatter() {
            private DocumentFilter portNumberFormatter = new info.sarihh.unimodeling.utility.NumberFieldFormatter(2);
            protected DocumentFilter getDocumentFilter() {
                return portNumberFormatter;
            }
        });
        condensingRepeatsLabel = new javax.swing.JLabel();
        condensingRepeatsTextField = new javax.swing.JFormattedTextField(new DefaultFormatter() {
            private DocumentFilter portNumberFormatter = new info.sarihh.unimodeling.utility.NumberFieldFormatter(2);
            protected DocumentFilter getDocumentFilter() {
                return portNumberFormatter;
            }
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("info/sarihh/unimodeling/gui/RFIDServerFrame"); // NOI18N
        registerStreamDialog.setTitle(bundle.getString("RFIDServerFrame.registerStreamDialog.title")); // NOI18N
        ...
        okButton.setText(bundle.getString("RFIDServerFrame.okButton.text")); // NOI18N
        ...
        connectDatabaseDialog.setTitle(bundle.getString("RFIDServerFrame.connectDatabaseDialog.title")); // NOI18N
        ...
        driversLabel.setText(bundle.getString("RFIDServerFrame.driversLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        ...
        urlLabel.setText(bundle.getString("RFIDServerFrame.urlLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        ...
        userNameLabel.setText(bundle.getString("RFIDServerFrame.userNameLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        ...
        userNameTextField.setToolTipText(bundle.getString("RFIDServerFrame.userNameTextField.toolTipText")); // NOI18N
        ...
        passwordLabel.setText(bundle.getString("RFIDServerFrame.passwordLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        testButton.setText(bundle.getString("RFIDServerFrame.testButton.text")); // NOI18N
        ...
        okButton1.setText(bundle.getString("RFIDServerFrame.okButton1.text")); // NOI18N
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle(bundle.getString("RFIDServerFrame.title")); // NOI18N

        containerPanel.setLayout(new java.awt.GridBagLayout());

        portNumberLabel.setText(bundle.getString("RFIDServerFrame.portNumberLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        containerPanel.add(portNumberLabel, gridBagConstraints);

        portNumberTextField.setText("12345"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.gridwidth = 3;
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        containerPanel.add(portNumberTextField, gridBagConstraints);

        condensingStartsLabel.setText(bundle.getString("RFIDServerFrame.condensingStartsLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        containerPanel.add(condensingStartsLabel, gridBagConstraints);

        condensingStartsTextField.setText("1"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.gridwidth = 3;
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        containerPanel.add(condensingStartsTextField, gridBagConstraints);

        condensingRepeatsLabel.setText(bundle.getString("RFIDServerFrame.condensingRepeatsLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        containerPanel.add(condensingRepeatsLabel, gridBagConstraints);

        condensingRepeatsTextField.setText("15"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.gridwidth = 3;
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        containerPanel.add(condensingRepeatsTextField, gridBagConstraints);

        activityLogScrollPane.setBorder(javax.swing.BorderFactory.createTitledBorder(bundle.getString("RFIDServerFrame.activityLogScrollPane.border.title"))); // NOI18N
        ...
        registerStreamButton.setText(bundle.getString("RFIDServerFrame.registerStreamButton.text")); // NOI18N
        ...
        connectDatabaseButton.setText(bundle.getString("RFIDServerFrame.connectDatabaseButton.text")); // NOI18N
        ...
        createAppearTableButton.setText(bundle.getString("RFIDServerFrame.createAppearTableButton.text")); // NOI18N
        ...
        launchServerButton.setText(bundle.getString("RFIDServerFrame.launchServerButton.text")); // NOI18N
        launchServerButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                launchServerButtonActionPerformed(evt);
            }
        });
        buttonPanel.add(launchServerButton);

        stopServerButton.setText(bundle.getString("RFIDServerFrame.stopServerButton.text")); // NOI18N
        ...
        clearLogButton.setText(bundle.getString("RFIDServerFrame.clearLogButton.text")); // NOI18N
...
private void stopServerButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_stopServerButtonActionPerformed
    ...
    try {
        serverSocket.close();
        appendLogText("The server is stopped.");
        switchButtonState(launchServerButton, stopServerButton);
    } catch (Exception e) {
        appendLogText(e.toString().contains("SocketException") ? "" : e.toString());
        switchButtonState(stopServerButton, launchServerButton);
    }
...
private void launchServerButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_launchServerButtonActionPerformed
    Thread serverThread = new Thread() {
        ...
        public void run() {
            try {
                serverSocket = new ServerSocket(Integer.parseInt(portNumberTextField.getText()));
                appendLogText("Waiting for connection on " + serverSocket + ".");
                switchButtonState(stopServerButton, launchServerButton);
                while (true) {
                    Socket client = serverSocket.accept();
                    appendLogText("A connection from " + client + ".");
                    ObjectOutputStream clientOutputStream = new ObjectOutputStream(client.getOutputStream());
                    clientOutputStreams.put(client, clientOutputStream);
                    new ClientHandler(RFIDServerFrame.this, client).start();
                }
            } catch (Exception e) {
                appendLogText(e.toString().contains("SocketException") ? "" : e.toString());
...
private void registerStreamButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerStreamButtonActionPerformed
    SwingUtilities.invokeLater(new Runnable() {
        ...
        public void run() {
            registerStreamDialog.setLocationRelativeTo(RFIDServerFrame.this);
...
private void connectDatabaseButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_connectDatabaseButtonActionPerformed
    SwingUtilities.invokeLater(new Runnable() {
        ...
        public void run() {
            connectDatabaseDialog.setLocationRelativeTo(RFIDServerFrame.this);
...
private void testButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_testButtonActionPerformed
    ...
    if (conn != null) {
        JOptionPane.showMessageDialog(RFIDServerFrame.this,
...
private void driversComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_driversComboBoxActionPerformed
    ...
    public void removeConnection(Socket client) {
        try {
            appendLogText("Removing connection with " + client + ".");
            client.close();
    ...
    public void removeAllConnection() {
        try {
            for (Socket client : clientOutputStreams.keySet()) {
                appendLogText("Removing connection with " + client + ".");
                client.close();
                clientOutputStreams.remove(client);
            }
    ...
    public void sendTo(String message, Socket client) {
        try {
            ObjectOutputStream out = clientOutputStreams.get(client);
    ...
    public int getCondensingStarts() {
        return 1000 * Integer.parseInt(condensingStartsTextField.getText());
    }

    public int getCondensingRepeats() {
        return 1000 * Integer.parseInt(condensingRepeatsTextField.getText());
    }
    ...
    private void createAppearTable() {
        try {
            ...
            if (!exist) {
                ...
                sb.append("S_TIME TIMESTAMP,\n");
                sb.append("E_TIME TIMESTAMP)");
    ...
    private javax.swing.JLabel condensingRepeatsLabel;
    private javax.swing.JFormattedTextField condensingRepeatsTextField;
    private javax.swing.JLabel condensingStartsLabel;
    private javax.swing.JFormattedTextField condensingStartsTextField;
    ...
    private javax.swing.JFormattedTextField portNumberTextField;
